# Terraform configuration for Portify AWS ECS Fargate deployment
  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        ...
        {
          name      = "KITE_API_KEY"
          valueFrom = aws_ssm_parameter.kite_api_key.arn
        },
        {
          name      = "KITE_API_SECRET"
          valueFrom = aws_ssm_parameter.kite_api_secret.arn
        }
      ]
    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          aws_ssm_parameter.kite_api_key.arn,
          aws_ssm_parameter.kite_api_secret.arn
        ]
      }
    ]
  })
